...
If you do not see this or cannot map your binding to `Insert`, you will need to manually map it in your GameUserSettings.ini file located in the same path as your `Engine.ini` and `Game.ini` files
